...
bmds = [
    LocationData(LocationName.Robot_Control_Comp_1_BMD_1,     0xB61001, 0x02001F24, 0x80, LocationType.BlueMysteryData, 0x0A13C4)
    LocationData(LocationName.Robot_Control_Comp_1_BMD_2,     0xB61002, 0x02001F24, 0x40, LocationType.BlueMysteryData, 0x0A13D0)
    LocationData(LocationName.Robot_Control_Comp_2_BMD_1,     0xB61003, 0x02001F25, 0x80, LocationType.BlueMysteryData, 0x0A14C8)
    LocationData(LocationName.Robot_Control_Comp_2_BMD_2,     0xB61004, 0x02001F25, 0x40, LocationType.BlueMysteryData, 0x0A14D4)
    LocationData(LocationName.Aquarium_Comp_1_BMD_1,          0xB61005, 0x02001F28, 0x80, LocationType.BlueMysteryData, 0x0A1610)
    LocationData(LocationName.Aquarium_Comp_1_BMD_2,          0xB61006, 0x02001F28, 0x40, LocationType.BlueMysteryData, 0x0A161C)
    LocationData(LocationName.Aquarium_Comp_2_BMD_1,          0xB61007, 0x02001F29, 0x80, LocationType.BlueMysteryData, 0x0A1714)
    LocationData(LocationName.Aquarium_Comp_2_BMD_2,          0xB61008, 0x02001F29, 0x40, LocationType.BlueMysteryData, 0x0A1720)
    LocationData(LocationName.Aquarium_Comp_3_BMD_1,          0xB61009, 0x02001F2A, 0x80, LocationType.BlueMysteryData, 0x0A1818)
    LocationData(LocationName.Aquarium_Comp_3_BMD_2,          0xB6100A, 0x02001F2A, 0x40, LocationType.BlueMysteryData, 0x0A1824)
    LocationData(LocationName.JudgeTree_Comp_1_BMD_1,         0xB6100B, 0x02001F2C, 0x80, LocationType.BlueMysteryData, 0x0A1960)
    LocationData(LocationName.JudgeTree_Comp_1_BMD_2,         0xB6100C, 0x02001F2C, 0x40, LocationType.BlueMysteryData, 0x0A196C)
    LocationData(LocationName.JudgeTree_Comp_2_BMD_1,         0xB6100D, 0x02001F2D, 0x80, LocationType.BlueMysteryData, 0x0A1A64)
    LocationData(LocationName.JudgeTree_Comp_2_BMD_2,         0xB6100E, 0x02001F2D, 0x40, LocationType.BlueMysteryData, 0x0A1A70)
    LocationData(LocationName.JudgeTree_Comp_3_BMD_1,         0xB6100F, 0x02001F2E, 0x80, LocationType.BlueMysteryData, 0x0A1B68)
    LocationData(LocationName.JudgeTree_Comp_3_BMD_2,         0xB61010, 0x02001F2E, 0x40, LocationType.BlueMysteryData, 0x0A1B74)
    LocationData(LocationName.Mr_Weather_Comp_1_BMD_1,        0xB61011, 0x02001F30, 0x80, LocationType.BlueMysteryData, 0x0A1CB0)
    LocationData(LocationName.Mr_Weather_Comp_1_BMD_2,        0xB61012, 0x02001F30, 0x40, LocationType.BlueMysteryData, 0x0A1CBC)
    LocationData(LocationName.Mr_Weather_Comp_2_BMD_1,        0xB61013, 0x02001F31, 0x80, LocationType.BlueMysteryData, 0x0A1DB4)
    LocationData(LocationName.Mr_Weather_Comp_2_BMD_2,        0xB61014, 0x02001F31, 0x40, LocationType.BlueMysteryData, 0x0A1DC0)
    LocationData(LocationName.Mr_Weather_Comp_3_BMD_1,        0xB61015, 0x02001F32, 0x80, LocationType.BlueMysteryData, 0x0A1EB8)
    LocationData(LocationName.Mr_Weather_Comp_3_BMD_2,        0xB61016, 0x02001F32, 0x40, LocationType.BlueMysteryData, 0x0A1EC4)
    LocationData(LocationName.Pavilion_Comp_1_BMD_1,          0xB61017, 0x02001F38, 0x80, LocationType.BlueMysteryData, 0x0A2000)
    LocationData(LocationName.Pavilion_Comp_1_BMD_2,          0xB61018, 0x02001F38, 0x40, LocationType.BlueMysteryData, 0x0A200C)
    LocationData(LocationName.Pavilion_Comp_2_BMD_1,          0xB61019, 0x02001F38, 0x08, LocationType.BlueMysteryData, 0x0A2104)
    LocationData(LocationName.Pavilion_Comp_2_BMD_2,          0xB6101A, 0x02001F38, 0x04, LocationType.BlueMysteryData, 0x0A2110)
    LocationData(LocationName.Pavilion_Comp_3_BMD_1,          0xB6101B, 0x02001F39, 0x80, LocationType.BlueMysteryData, 0x0A2208)
    LocationData(LocationName.Pavilion_Comp_3_BMD_2,          0xB6101C, 0x02001F39, 0x40, LocationType.BlueMysteryData, 0x0A2214)
    LocationData(LocationName.Pavilion_Comp_4_BMD_1,          0xB6101D, 0x02001F39, 0x08, LocationType.BlueMysteryData, 0x0A230C)
    LocationData(LocationName.Pavilion_Comp_4_BMD_2,          0xB6101E, 0x02001F39, 0x04, LocationType.BlueMysteryData, 0x0A2318)
    LocationData(LocationName.ACDC_HP_BMD,                    0xB6101F, 0x02001F40, 0x08, LocationType.BlueMysteryData, 0x0A2458)
    LocationData(LocationName.Aquarium_HP_BMD,                0xB61020, 0x02001F41, 0x08, LocationType.BlueMysteryData, 0x0A24A4)
    LocationData(LocationName.Green_HP_BMD,                   0xB61021, 0x02001F42, 0x08, LocationType.BlueMysteryData, 0x0A24F0)
    LocationData(LocationName.Sky_HP_BMD,                     0xB61022, 0x02001F43, 0x80, LocationType.BlueMysteryData, 0x0A253C)
    LocationData(LocationName.RoboDog_Comp_BMD,               0xB61023, 0x02001F48, 0x80, LocationType.BlueMysteryData, 0x0A25CC)
    LocationData(LocationName.Labs_Comp_1_BMD_1,              0xB61024, 0x02001F48, 0x20, LocationType.BlueMysteryData, 0x0A25F4)
    LocationData(LocationName.Labs_Comp_1_BMD_2,              0xB61025, 0x02001F48, 0x10, LocationType.BlueMysteryData, 0x0A2600)
    LocationData(LocationName.Class_6_1_Comp_BMD_1,           0xB61026, 0x02001F48, 0x08, LocationType.BlueMysteryData, 0x0A2640)
    LocationData(LocationName.Class_6_1_Comp_BMD_2,           0xB61027, 0x02001F48, 0x04, LocationType.BlueMysteryData, 0x0A264C)
    LocationData(LocationName.Class_6_2_Comp_BMD,             0xB61028, 0x02001F48, 0x02, LocationType.BlueMysteryData, 0x0A268C)
    LocationData(LocationName.Class_1_1_Comp_BMD_1,           0xB61029, 0x02001F49, 0x80, LocationType.BlueMysteryData, 0x0A26D8)
    LocationData(LocationName.Class_1_1_Comp_BMD_2,           0xB6102A, 0x02001F49, 0x40, LocationType.BlueMysteryData, 0x0A26E4)
    LocationData(LocationName.Class_1_2_Comp_BMD_1,           0xB6102B, 0x02001F49, 0x20, LocationType.BlueMysteryData, 0x0A2724)
    LocationData(LocationName.Class_1_2_Comp_BMD_2,           0xB6102C, 0x02001F49, 0x10, LocationType.BlueMysteryData, 0x0A2730)
    LocationData(LocationName.Bathroom_Comp_BMD,              0xB6102D, 0x02001F49, 0x08, LocationType.BlueMysteryData, 0x0A2770)
    LocationData(LocationName.Elevator_Comp_BMD,              0xB6102E, 0x02001F49, 0x02, LocationType.BlueMysteryData, 0x0A2798)
    LocationData(LocationName.Fish_Stick_Shop_Comp_BMD_1,     0xB6102F, 0x02001F4A, 0x80, LocationType.BlueMysteryData, 0x0A27C0)
    LocationData(LocationName.Fish_Stick_Shop_Comp_BMD_2,     0xB61030, 0x02001F4A, 0x40, LocationType.BlueMysteryData, 0x0A27CC)
    LocationData(LocationName.Security_Camera_Comp_BMD_1,     0xB61031, 0x02001F4A, 0x20, LocationType.BlueMysteryData, 0x0A280C)
    LocationData(LocationName.Security_Camera_Comp_BMD_2,     0xB61032, 0x02001F4A, 0x10, LocationType.BlueMysteryData, 0x0A2818)
    LocationData(LocationName.Book_Comp_BMD_1,                0xB61033, 0x02001F4A, 0x08, LocationType.BlueMysteryData, 0x0A2858)
    LocationData(LocationName.Book_Comp_BMD_2,                0xB61034, 0x02001F4A, 0x04, LocationType.BlueMysteryData, 0x0A2864)
    LocationData(LocationName.Fan_Comp_BMD_1,                 0xB61035, 0x02001F4A, 0x02, LocationType.BlueMysteryData, 0x0A28A4)
    LocationData(LocationName.Fan_Comp_BMD_2,                 0xB61036, 0x02001F4A, 0x01, LocationType.BlueMysteryData, 0x0A28B0)
    LocationData(LocationName.Air_Conditioner_Comp_BMD_1,     0xB61037, 0x02001F4B, 0x80, LocationType.BlueMysteryData, 0x0A28F0)
    LocationData(LocationName.Air_Conditioner_Comp_BMD_2,     0xB61038, 0x02001F4B, 0x40, LocationType.BlueMysteryData, 0x0A28FC)
    LocationData(LocationName.Heater_Comp_BMD_1,              0xB61039, 0x02001F4B, 0x20, LocationType.BlueMysteryData, 0x0A293C)
    LocationData(LocationName.Heater_Comp_BMD_2,              0xB6103A, 0x02001F4B, 0x10, LocationType.BlueMysteryData, 0x0A2948)
    LocationData(LocationName.Shower_Comp_BMD_1,              0xB6103B, 0x02001F4B, 0x08, LocationType.BlueMysteryData, 0x0A2988)
    LocationData(LocationName.Shower_Comp_BMD_2,              0xB6103C, 0x02001F4B, 0x04, LocationType.BlueMysteryData, 0x0A2994)
    LocationData(LocationName.Heliport_Comp_BMD_1,            0xB6103D, 0x02001F4B, 0x02, LocationType.BlueMysteryData, 0x0A29D4)
    LocationData(LocationName.Heliport_Comp_BMD_2,            0xB6103E, 0x02001F4B, 0x01, LocationType.BlueMysteryData, 0x0A29E0)
    LocationData(LocationName.Labs_Comp_2_BMD,                0xB6103F, 0x02001F4C, 0x80, LocationType.BlueMysteryData, 0x0A2A64)
    LocationData(LocationName.Vending_Machine_Comp_BMD_1,     0xB61040, 0x02001F4C, 0x20, LocationType.BlueMysteryData, 0x0A2AB0)
    LocationData(LocationName.Vending_Machine_Comp_BMD_2,     0xB61041, 0x02001F4C, 0x10, LocationType.BlueMysteryData, 0x0A2ABC)
    LocationData(LocationName.Punish_Chair_Comp_BMD,          0xB61042, 0x02001F4C, 0x08, LocationType.BlueMysteryData, 0x0A2AFC)
    LocationData(LocationName.Water_Machine_Comp_BMD,         0xB61043, 0x02001F4C, 0x02, LocationType.BlueMysteryData, 0x0A2B48)
    LocationData(LocationName.Symbol_Comp_BMD_1,              0xB61044, 0x02001F4D, 0x80, LocationType.BlueMysteryData, 0x0A2B70)
    LocationData(LocationName.Symbol_Comp_BMD_2,              0xB61045, 0x02001F4D, 0x40, LocationType.BlueMysteryData, 0x0A2B7C)
    LocationData(LocationName.Monitor_Comp_BMD,               0xB61046, 0x02001F4D, 0x20, LocationType.BlueMysteryData, 0x0A2BBC)
    LocationData(LocationName.Popcorn_Shop_Comp_BMD,          0xB61047, 0x02001F4D, 0x08, LocationType.BlueMysteryData, 0x0A2BE4)
    LocationData(LocationName.Teachers_Room_Comp_BMD_1,       0xB61048, 0x02001F4D, 0x02, LocationType.BlueMysteryData, 0x0A2C0C)
    LocationData(LocationName.Teachers_Room_Comp_BMD_2,       0xB61049, 0x02001F4D, 0x01, LocationType.BlueMysteryData, 0x0A2C18)
    LocationData(LocationName.Pipe_Comp_BMD,                  0xB6104A, 0x02001F4E, 0x80, LocationType.BlueMysteryData, 0x0A2C58)
    LocationData(LocationName.Observation_Comp_BMD_1,         0xB6104B, 0x02001F4E, 0x20, LocationType.BlueMysteryData, 0x0A2C80)
    LocationData(LocationName.Observation_Comp_BMD_2,         0xB6104C, 0x02001F4E, 0x10, LocationType.BlueMysteryData, 0x0A2C8C)
    LocationData(LocationName.Oxygen_Tank_Comp_BMD,           0xB6104D, 0x02001F4E, 0x08, LocationType.BlueMysteryData, 0x0A2CCC)
    LocationData(LocationName.Principals_Office_Comp_BMD_1,   0xB6104E, 0x02001F4E, 0x02, LocationType.BlueMysteryData, 0x0A2D18)
    LocationData(LocationName.Principals_Office_Comp_BMD_2,   0xB6104F, 0x02001F4E, 0x01, LocationType.BlueMysteryData, 0x0A2D24)
    LocationData(LocationName.Mascot_Comp_BMD_1,              0xB61050, 0x02001F4F, 0x80, LocationType.BlueMysteryData, 0x0A2D64)
    LocationData(LocationName.Mascot_Comp_BMD_2,              0xB61051, 0x02001F4F, 0x40, LocationType.BlueMysteryData, 0x0A2D70)
    LocationData(LocationName.Stuffed_Toy_Shop_Comp_BMD_1,    0xB61052, 0x02001F4F, 0x20, LocationType.BlueMysteryData, 0x0A2DB0)
    LocationData(LocationName.Stuffed_Toy_Shop_Comp_BMD_2,    0xB61053, 0x02001F4F, 0x10, LocationType.BlueMysteryData, 0x0A2DBC)
    LocationData(LocationName.Dog_House_Comp_BMD_1,           0xB61054, 0x02001F4F, 0x08, LocationType.BlueMysteryData, 0x0A2DFC)
    LocationData(LocationName.Dog_House_Comp_BMD_2,           0xB61055, 0x02001F4F, 0x04, LocationType.BlueMysteryData, 0x0A2E08)
    LocationData(LocationName.Guide_Panel_Comp_BMD,           0xB61056, 0x02001F4F, 0x02, LocationType.BlueMysteryData, 0x0A2E48)
    LocationData(LocationName.Central_Area_1_BMD_1,           0xB61057, 0x02001F08, 0x80, LocationType.BlueMysteryData, 0x0A2EB4)
    LocationData(LocationName.Central_Area_1_BMD_2,           0xB61058, 0x02001F08, 0x40, LocationType.BlueMysteryData, 0x0A2EC0)
    LocationData(LocationName.Central_Area_2_BMD_1,           0xB61059, 0x02001F09, 0x80, LocationType.BlueMysteryData, 0x0A2FC8)
    LocationData(LocationName.Central_Area_2_BMD_2,           0xB6105A, 0x02001F09, 0x40, LocationType.BlueMysteryData, 0x0A2FD4)
    LocationData(LocationName.Central_Area_3_BMD,             0xB6105B, 0x02001F0A, 0x80, LocationType.BlueMysteryData, 0x0A30DC)
    LocationData(LocationName.Seaside_Area_1_BMD_1,           0xB6105C, 0x02001F0C, 0x80, LocationType.BlueMysteryData, 0x0A3234)
    LocationData(LocationName.Seaside_Area_1_BMD_2,           0xB6105D, 0x02001F0C, 0x40, LocationType.BlueMysteryData, 0x0A3240)
    LocationData(LocationName.Seaside_Area_1_BMD_3,           0xB6105E, 0x02001F0C, 0x08, LocationType.BlueMysteryData, 0x0A3264)
    LocationData(LocationName.Seaside_Area_2_BMD_1,           0xB6105F, 0x02001F0D, 0x80, LocationType.BlueMysteryData, 0x0A336C)
    LocationData(LocationName.Seaside_Area_2_BMD_2,           0xB61060, 0x02001F0D, 0x40, LocationType.BlueMysteryData, 0x0A3378)
    LocationData(LocationName.Seaside_Area_2_BMD_3,           0xB61061, 0x02001F0D, 0x08, LocationType.BlueMysteryData, 0x0A339C)
    LocationData(LocationName.Seaside_Area_3_BMD,             0xB61062, 0x02001F0E, 0x80, LocationType.BlueMysteryData, 0x0A34A4)
    LocationData(LocationName.Green_Area_1_BMD_1,             0xB61063, 0x02001F10, 0x80, LocationType.BlueMysteryData, 0x0A35FC)
    LocationData(LocationName.Green_Area_1_BMD_2,             0xB61064, 0x02001F10, 0x08, LocationType.BlueMysteryData, 0x0A362C)
    LocationData(LocationName.Green_Area_2_BMD_1,             0xB61065, 0x02001F11, 0x80, LocationType.BlueMysteryData, 0x0A3734)
    LocationData(LocationName.Green_Area_2_BMD_2,             0xB61066, 0x02001F11, 0x40, LocationType.BlueMysteryData, 0x0A3740)
    LocationData(LocationName.Green_Area_2_BMD_3,             0xB61067, 0x02001F11, 0x08, LocationType.BlueMysteryData, 0x0A3764)
    LocationData(LocationName.Underground_2_BMD_1,            0xB61068, 0x02001F15, 0x80, LocationType.BlueMysteryData, 0x0A39C4)
    LocationData(LocationName.Underground_2_BMD_2,            0xB61069, 0x02001F15, 0x08, LocationType.BlueMysteryData, 0x0A39E8)
    LocationData(LocationName.Sky_Area_1_BMD_1,               0xB6106A, 0x02001F18, 0x80, LocationType.BlueMysteryData, 0x0A3B1C)
    LocationData(LocationName.Sky_Area_1_BMD_2,               0xB6106B, 0x02001F18, 0x08, LocationType.BlueMysteryData, 0x0A3B4C)
    LocationData(LocationName.Sky_Area_2_BMD_1,               0xB6106C, 0x02001F19, 0x80, LocationType.BlueMysteryData, 0x0A3C54)
    LocationData(LocationName.Sky_Area_2_BMD_2,               0xB6106D, 0x02001F19, 0x40, LocationType.BlueMysteryData, 0x0A3C60)
    LocationData(LocationName.Sky_Area_2_BMD_3,               0xB6106E, 0x02001F19, 0x08, LocationType.BlueMysteryData, 0x0A3C84)
    LocationData(LocationName.ACDC_Area_BMD_1,                0xB6106F, 0x02001F1A, 0x80, LocationType.BlueMysteryData, 0x0A3D8C)
    LocationData(LocationName.ACDC_Area_BMD_2,                0xB61070, 0x02001F1A, 0x08, LocationType.BlueMysteryData, 0x0A3DBC)
    LocationData(LocationName.Undernet_1_BMD,                 0xB61071, 0x02001F1C, 0x80, LocationType.BlueMysteryData, 0x0A3F08)
    LocationData(LocationName.Undernet_Zero_BMD_1,            0xB61072, 0x02001F1D, 0x80, LocationType.BlueMysteryData, 0x0A401C)
    LocationData(LocationName.Undernet_Zero_BMD_2,            0xB61073, 0x02001F1D, 0x40, LocationType.BlueMysteryData, 0x0A4028)
    LocationData(LocationName.Undernet_Zero_BMD_3,            0xB61074, 0x02001F1D, 0x20, LocationType.BlueMysteryData, 0x0A4034)
    LocationData(LocationName.Undernet_2_BMD,                 0xB61075, 0x02001F1E, 0x80, LocationType.BlueMysteryData, 0x0A4154)
    LocationData(LocationName.Graveyard_BMD_1,                0xB61076, 0x02001F21, 0x80, LocationType.BlueMysteryData, 0x0A4540)
    LocationData(LocationName.Graveyard_BMD_2,                0xB61077, 0x02001F21, 0x40, LocationType.BlueMysteryData, 0x0A454C)
    LocationData(LocationName.Graveyard_BMD_3,                0xB61078, 0x02001F21, 0x10, LocationType.BlueMysteryData, 0x0A4564)
    LocationData(LocationName.Graveyard_BMD_4,                0xB61079, 0x02001F21, 0x08, LocationType.BlueMysteryData, 0x0A4570)
    LocationData(LocationName.Graveyard_BMD_5,                0xB6107A, 0x02001F23, 0x01, LocationType.BlueMysteryData, 0x0A45A0)
]

pmds = [
    LocationData(LocationName.ACDC_HP_PMD,                    0xB6107B, 0x02001F40, 0x04, LocationType.PurpleMysteryData, 0x0A2464)
    LocationData(LocationName.Aquarium_HP_PMD,                0xB6107C, 0x02001F41, 0x04, LocationType.PurpleMysteryData, 0x0A24B0)
    LocationData(LocationName.Green_HP_PMD,                   0xB6107D, 0x02001F42, 0x04, LocationType.PurpleMysteryData, 0x0A24FC)
    LocationData(LocationName.Sky_HP_PMD,                     0xB6107E, 0x02001F43, 0x40, LocationType.PurpleMysteryData, 0x0A2548)
    LocationData(LocationName.Class_6_2_Comp_PMD,             0xB6107F, 0x02001F48, 0x01, LocationType.PurpleMysteryData, 0x0A2698)
    LocationData(LocationName.Labs_Comp_2_PMD,                0xB61080, 0x02001F4C, 0x40, LocationType.PurpleMysteryData, 0x0A2A70)
    LocationData(LocationName.Punish_Chair_Comp_PMD,          0xB61081, 0x02001F4C, 0x04, LocationType.PurpleMysteryData, 0x0A2B08)
    LocationData(LocationName.Oxygen_Tank_Comp_PMD,           0xB61082, 0x02001F4E, 0x04, LocationType.PurpleMysteryData, 0x0A2CD8)
    LocationData(LocationName.Central_Area_3_PMD,             0xB61083, 0x02001F0A, 0x40, LocationType.PurpleMysteryData, 0x0A30E8)
    LocationData(LocationName.Seaside_Area_3_PMD,             0xB61084, 0x02001F0E, 0x40, LocationType.PurpleMysteryData, 0x0A34B0)
    LocationData(LocationName.Green_Area_1_PMD,               0xB61085, 0x02001F10, 0x40, LocationType.PurpleMysteryData, 0x0A3608)
    LocationData(LocationName.Underground_1_PMD_1,            0xB61086, 0x02001F14, 0x80, LocationType.PurpleMysteryData, 0x0A38B0)
    LocationData(LocationName.Underground_1_PMD_2,            0xB61087, 0x02001F14, 0x40, LocationType.PurpleMysteryData, 0x0A38BC)
    LocationData(LocationName.Sky_Area_1_PMD,                 0xB61088, 0x02001F18, 0x40, LocationType.PurpleMysteryData, 0x0A3B28)
    LocationData(LocationName.ACDC_Area_PMD,                  0xB61089, 0x02001F1A, 0x40, LocationType.PurpleMysteryData, 0x0A3D98)
    LocationData(LocationName.Undernet_1_PMD,                 0xB6108A, 0x02001F1C, 0x40, LocationType.PurpleMysteryData, 0x0A3F14)
    LocationData(LocationName.Undernet_2_PMD,                 0xB6108B, 0x02001F1E, 0x40, LocationType.PurpleMysteryData, 0x0A4160)
    LocationData(LocationName.Graveyard_PMD_1,                0xB6108C, 0x02001F21, 0x20, LocationType.PurpleMysteryData, 0x0A4558)
    LocationData(LocationName.Graveyard_PMD_2,                0xB6108D, 0x02001F21, 0x04, LocationType.PurpleMysteryData, 0x0A457C)
]
