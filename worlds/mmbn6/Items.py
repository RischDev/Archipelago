...
programList: typing.List[ItemData] = [
    ...
    ItemData(0xB610B9, ItemName.Charge_Plus_Blue, ItemClassification.filler, ItemType.Program, 37, ProgramColor.Blue),
    ...
    ItemData(0xB610DB, ItemName.Speed_Plus_Green, ItemClassification.filler, ItemType.Program, 36, ProgramColor.Green),
